customerUpdate.onshow=function(){
  ...
  txtUpdatedCustomer_contents.style.height = "200px"
...
btnUpdate.onclick=function(){
    query = "UPDATE customer SET name =" + '"' + inptUpdate.value + '"' + " WHERE name = " + '"' + drpCustomerUpdate.value + '"'
    req = Ajax("https://ormond.creighton.edu/courses/375/ajax-connection.php", "POST", "host=ormond.creighton.edu&user=qzh72014&pass=" + pw + "&database=qzh72014&query=" + query)
    ...
    let message = ""
              ...
              txtUpdatedCustomer.value = message
         }
      }
}
